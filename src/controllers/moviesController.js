...
const API = `http://www.omdbapi.com/?apikey=${process.env.APIKEY_OMDB}`;
        ...
        try {
            ...
            if (result) {
                let movie = {
                    ...
                    Rutine: result.length
                }
            } else {
                let response = await fetch(`http://www.omdbapi.com?apikey=${process.env.APIKEY_OMDB}&t=${titulo}`);
